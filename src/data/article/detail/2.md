...
[安装Vant](https://www.jspang.com/detailed?id=61#toc312)
...
[建立首页组件](https://www.jspang.com/detailed?id=61#toc325)
...
[第06节：首页轮播图的制作](https://www.jspang.com/detailed?id=61#toc230)
...
[获取推荐商品数据](https://www.jspang.com/detailed?id=61#toc351)
...
[竖屏切换效果](https://www.jspang.com/detailed?id=61#toc356)
...
[第11节：vue-awesome-swiper 详讲2](https://www.jspang.com/detailed?id=61#toc257)
...
[规则部分的布局](https://www.jspang.com/detailed?id=61#toc366)
...
[第22节： Mongoose的Schema建模介绍](https://www.jspang.com/detailed?id=61#toc1105)
...
[初学定义一个用户Schema](https://www.jspang.com/detailed?id=61#toc3108)
...
[第23节： 载入Schema和插入查出数据](https://www.jspang.com/detailed?id=61#toc2109)

[![花点小钱看视频](http://7xjyw1.com1.z0.glb.clouddn.com/fukuanover.jpg)](https://www.jspang.com/detailed?id=61#payFor)

Schema建立好以后，需要我们载入这些数据库，当然最好的方法就是在后台服务已启动的时候就把载入做好，所以我们在`service/init.js`里作这件事，然后在index.js里直接执行。

[载入所有Schema](https://www.jspang.com/detailed?id=61#toc3110)
...
[插入一条数据](https://www.jspang.com/detailed?id=61#toc3111)
...
[读出已经插入进去的数据](https://www.jspang.com/detailed?id=61#toc3112)
...
[第24节： 打造安全的用户密码加密机制](https://www.jspang.com/detailed?id=61#toc2113)

[![花点小钱看视频](http://7xjyw1.com1.z0.glb.clouddn.com/fukuanover.jpg)](https://www.jspang.com/detailed?id=61#payFor)

通过学习，虽然可以对数据库的可以进行插入操作了，但是现在使用的都是普通的明文密码，这在实际工作中是肯定不允许，需要对密码进行加密和加盐的处理。

[加密处理](https://www.jspang.com/detailed?id=61#toc3114)
...
[加盐处理](https://www.jspang.com/detailed?id=61#toc3115)
...
[bcrypt的使用](https://www.jspang.com/detailed?id=61#toc3116)
...
[第25节： 编写注册页面前端视图](https://www.jspang.com/detailed?id=61#toc2117)

[![花点小钱看视频](http://7xjyw1.com1.z0.glb.clouddn.com/fukuanover.jpg)](https://www.jspang.com/detailed?id=61#payFor) 不好意思，这一周都在出差，今天到家马上给大家编写教材。我们已经学会了用户表Schema的建立，并进行了安全机制的处理。这节开始我们就把用户注册登录这一部分进行完善。当你把这部分学完，你一定会对Koa+vue的前后台全栈开发有更深的理解。（这节课主要讲页面的编写，基础好的同学可以跳过本节，自己作更漂亮的注册页面）

[注册页面的vue模板编写](https://www.jspang.com/detailed?id=61#toc3118)
...
[第26节： Koa2的用户操作的路由模块化](https://www.jspang.com/detailed?id=61#toc2119)
...
[安装koa-router](https://www.jspang.com/detailed?id=61#toc3120)
...
[新建一个User.js的文件](https://www.jspang.com/detailed?id=61#toc3121)
...
[让路由模块化](https://www.jspang.com/detailed?id=61#toc3122)
...
[第27节：打通注册用户的前后端通讯](https://www.jspang.com/detailed?id=61#toc2123)

[![花点小钱看视频](http://7xjyw1.com1.z0.glb.clouddn.com/fukuanover.jpg)](https://www.jspang.com/detailed?id=61#payFor)

这节我们要把前后端进行打通，使用API接口的形式可以互相同通讯和传递数据。看起来比较简单，但是这节课的内容还是比较多的，希望小伙伴能认真对待这节内容，然后课下练习。

[安装koa-bodyparser中间件](https://www.jspang.com/detailed?id=61#toc3124)
...
[前台的axios请求处理](https://www.jspang.com/detailed?id=61#toc3125)
...
[让koa2支持跨域请求](https://www.jspang.com/detailed?id=61#toc3126)
...
[编写koa2接收前台数据的方法](https://www.jspang.com/detailed?id=61#toc3127)
...
[第28节：用户注册数据库操作](https://www.jspang.com/detailed?id=61#toc2128)
...
[Koa2的User.js 接口的完善](https://www.jspang.com/detailed?id=61#toc3129)
...
[前端Vue的业务处理](https://www.jspang.com/detailed?id=61#toc3130)
...
[第29节：注册的防重复提交](https://www.jspang.com/detailed?id=61#toc2131)
...
[1.在按钮上绑定loading属性](https://www.jspang.com/detailed?id=61#toc3132)
...
[2.改写我们的注册方法](https://www.jspang.com/detailed?id=61#toc3133)
...
[解决一个网友的小问题](https://www.jspang.com/detailed?id=61#toc3134)
...
[第30节：注册时的前端验证](https://www.jspang.com/detailed?id=61#toc2135)

[![花点小钱看视频](http://7xjyw1.com1.z0.glb.clouddn.com/fukuanover.jpg)](https://www.jspang.com/detailed?id=61#payFor)

现在的注册是可以提交null值的，比如用户名为空或者密码为空都是可以提交到Koa服务端进行处理的，在工作中这是绝对不允许的，所以必须从前端就可以作表单验证，然后后端也需要作数据验证。这节课我们就学一下前端如何作表单验证。

[1.首先为Field绑定error-message属性](https://www.jspang.com/detailed?id=61#toc3136)
...
[2.编写验证方法checkFrom](https://www.jspang.com/detailed?id=61#toc3137)
...
[3.重新编写注册方法](https://www.jspang.com/detailed?id=61#toc3138)
...
[4.重新绑定注册按钮事件](https://www.jspang.com/detailed?id=61#toc3139)
...
[第31节：Vue的登录界面制作和路由配置](https://www.jspang.com/detailed?id=61#toc2140)

[![花点小钱看视频](http://7xjyw1.com1.z0.glb.clouddn.com/fukuanover.jpg)](https://www.jspang.com/detailed?id=61#payFor)

这节开始作登录部分的一些操作，登录部分我们尽量讲的细致一些，因为有很多小伙伴都在问登录部分的问题。登录也是任何一个项目必须使用的一个模块。好准备好，开始学习吧。

[1.复制Register.vue文件并进行修改](https://www.jspang.com/detailed?id=61#toc3141)
...
[2. 配置路由,让页面可以正常访问](https://www.jspang.com/detailed?id=61#toc3142)
...
[第32节：登录的服务端业务逻辑代码](https://www.jspang.com/detailed?id=61#toc2143)

[![花点小钱看视频](http://7xjyw1.com1.z0.glb.clouddn.com/fukuanover.jpg)](https://www.jspang.com/detailed?id=61#payFor)

页面已经做好了，现在可以制作一下服务端（后端）的服务代码了。其实登录的业务逻辑还是很简单的，就是得到前端发来的用户名和密码，然后跟数据库进行比对，如果正确就显示登录成功，失败就显示登录失败。

[Shema中的比对实例方法](https://www.jspang.com/detailed?id=61#toc3144)
...
[编写登录的Api接口](https://www.jspang.com/detailed?id=61#toc3145)
...
[前后端结合调试](https://www.jspang.com/detailed?id=61#toc3146)
...
[第33节：登录的前端交互效果制作和登录状态存储](https://www.jspang.com/detailed?id=61#toc2147)

[![花点小钱看视频](http://7xjyw1.com1.z0.glb.clouddn.com/fukuanover.jpg)](https://www.jspang.com/detailed?id=61#payFor)

这节课我们主要完成两个方面的制作，一个是前端用户的交互效果，另一个是登录状态存储。

[前端交互效果制作](https://www.jspang.com/detailed?id=61#toc3148)
...
[保存用户登录状态](https://www.jspang.com/detailed?id=61#toc3149)
...
[第34节：商品详细数据的提纯操作](https://www.jspang.com/detailed?id=61#toc2150)

这节开始准备页面的商品数据和类别数据，目的是制作我们的列表页和详细页。在课程中我会提供一个5万多条商品详情的JSON文件给你，但是这些数据多数是没有什么用处的，需要我们动手把有用的数据筛选出来，我把这种筛选叫做数据的提纯。

[用fs读入数据](https://www.jspang.com/detailed?id=61#toc3151)
...
[写入到新的文件中](https://www.jspang.com/detailed?id=61#toc3152)
...
[第35节：批量插入商品详情数据到MongoDB中](https://www.jspang.com/detailed?id=61#toc2153)

有了可插入的JSON数据，就可以建立一个Schema模型，然后是用Mongoose插入到我们的数据库中了，这节课就来学习如何批量插入到数据库中。

[1.建立Goods的Schema](https://www.jspang.com/detailed?id=61#toc3154)
...
[2.批量插入数据库的路由方法](https://www.jspang.com/detailed?id=61#toc3155)
...
[3.把路由加入到index.js里](https://www.jspang.com/detailed?id=61#toc3156)
...
[第36节：商品大类的Shema建立和导入数据库](https://www.jspang.com/detailed?id=61#toc2157)

这节课需要把商品大类的数据从JSON格式导入到MongoDB数据库中，涉及到的知识点有Schema的建立，fs模块的使用和Mongoose的存储。

[1.编写Category的Schema](https://www.jspang.com/detailed?id=61#toc3158)
...
[插入Mongodb数据库](https://www.jspang.com/detailed?id=61#toc3159)
...
[第37节：商品子类的Shema建立和导入数据库](https://www.jspang.com/detailed?id=61#toc2160)
...
[1.categorySub的Schema建立](https://www.jspang.com/detailed?id=61#toc3161)
...
[2.保存到数据库的业务逻辑](https://www.jspang.com/detailed?id=61#toc3162)
...
[第37节：商品子类的Shema建立和导入数据库](https://www.jspang.com/detailed?id=61#toc2163)

建议你看这节之前，完全可以自己先不开教程作一遍，因为这节课的知识我们都学过，但是为了巩固知识和视频的完整性，我们必须把这节录制上。我希望每个小伙伴都能作出这个项目，也算技术胖的良苦用心了。这节我们会把子类的Schema建立好，并用fs读取json文件，最后循环保存到数据库中。由于知识点前面都已经讲过，所以这里直接上代码了。

[1.categorySub的Schema建立](https://www.jspang.com/detailed?id=61#toc3164)
...
[2.保存到数据库的业务逻辑](https://www.jspang.com/detailed?id=61#toc3165)
...
[第38节：编写商品详情页的数据接口](https://www.jspang.com/detailed?id=61#toc2166)
...
[1.编写后台数据接口](https://www.jspang.com/detailed?id=61#toc3167)
...
[2.编写Goods.vue 页面](https://www.jspang.com/detailed?id=61#toc3168)
...
[3.把组件加入到路由管理中](https://www.jspang.com/detailed?id=61#toc3169)
...
[改写程序，让程序更优雅](https://www.jspang.com/detailed?id=61#toc3170)
...
[第40节：商品详情的页面模板编写-1](https://www.jspang.com/detailed?id=61#toc2171)

这节课我们开始编写Vue页面的样式，如果熟练使用Vue的小伙伴，可以根据自己的喜好布局编写。为了照顾小伙伴们，让每一个人都可以做出项目，我们还是手敲代码完成。

[1.引入Vant框架中的NavBar组件](https://www.jspang.com/detailed?id=61#toc3172)
...
[2.使用NavBar制作头部导航](https://www.jspang.com/detailed?id=61#toc3173)
...
[3.编写商品头图部分](https://www.jspang.com/detailed?id=61#toc3174)
...
[第41节：商品详情的页面模板编写-2](https://www.jspang.com/detailed?id=61#toc2175)
...
[vant标签组建的使用](https://www.jspang.com/detailed?id=61#toc3176)
...
[解决图片有空隙问题](https://www.jspang.com/detailed?id=61#toc3177)
...
[第42节：商品详情的页面模板编写-3](https://www.jspang.com/detailed?id=61#toc2178)

继续完善商品详情页的布局，这节主要是加入价格的顾虑器和底部的加入购物车和购买按钮。

[加入Filter过滤器，来格式化价格](https://www.jspang.com/detailed?id=61#toc3179)
...
2. 给价格加上Filter ,`goodsInfo.PRESENT_PRICE | moneyFilter`

通过上边的三部，我们就实现了价格的格式化。

[底部购买按钮和加入购物车按钮](https://www.jspang.com/detailed?id=61#toc3180)
...
[第43节：分类页面的数据读取](https://www.jspang.com/detailed?id=61#toc2181)

这节开始作商品列表页的操作，这个也会分好几节课来进行讲解，这节我们先学习从后台读取数据。

[读取大类别的API制作](https://www.jspang.com/detailed?id=61#toc3182)
...
[读取小类别的API制作](https://www.jspang.com/detailed?id=61#toc3183)
...
[根据商品类别获取商品列表](https://www.jspang.com/detailed?id=61#toc3184)
...
[第44节：补充商品详细页的滑动切换和吸顶效果](https://www.jspang.com/detailed?id=61#toc2185)

有小伙伴要求技术胖再补充两个详细页的功能，增加缓动切换Tab页面和吸顶效果。这节课我们就利用很短的时间给大家讲解一下这两个功能的制作。

[Tab页的滑动切换](https://www.jspang.com/detailed?id=61#toc3186)
...
[吸顶效果的制作](https://www.jspang.com/detailed?id=61#toc3187)
...
[第45节：商品列表页的布局-1](https://www.jspang.com/detailed?id=61#toc1188)

中间插入了一节补充的课程，这节转回来继续课程，这节我们开始布局分类列表页面。列表页面我们会讲到的效果会多一点，比如上拉加载，下拉刷新，Tab动态切换，都会讲到.....

[建立页面和配置列表页路由](https://www.jspang.com/detailed?id=61#toc3189)
...
[标题栏的布局](https://www.jspang.com/detailed?id=61#toc3190)
...
[大类的侧边栏的布局](https://www.jspang.com/detailed?id=61#toc3191)
...
[axios读取左侧大类](https://www.jspang.com/detailed?id=61#toc3192)
...
[第46节：商品列表页的大类交互效果制作](https://www.jspang.com/detailed?id=61#toc2193)

这节我们要把列表页左侧的大类布局和交互效果作出来，用到的知识点主要有声明周期，`v-for`循环，class的动态绑定和操作原生DOM。

[把大类列表放到左侧导航上](https://www.jspang.com/detailed?id=61#toc3194)
...
[点击后的交互效果制作-反白操作](https://www.jspang.com/detailed?id=61#toc3195)
...
[第47节：一二级分类的联动效果制作](https://www.jspang.com/detailed?id=61#toc2196)

这节我们要实现一、二级分类的联动效果，说的简单点就是当你点击一级分类时，二级分类要根据你点击的一级分类进行变化。上节课用了自己写的Tab页面方法，这节我们直接使用Vant的Tab组件来实现。

[在serviceAPI.config.js中加入接口](https://www.jspang.com/detailed?id=61#toc3197)
...
[改写后端接口](https://www.jspang.com/detailed?id=61#toc3198)

以前写后端接口时，为了测试，所以使用的是get方法，但是为了传送数据的安全和方便，现在改为post方法，并接受前端传递过来的`categoryId`参数。代码如下： 文件位置：`service/appApi/goods.js`
...
[获取小类的方法](https://www.jspang.com/detailed?id=61#toc3199)
...
[用Vant的Tabs组建实现联动](https://www.jspang.com/detailed?id=61#toc3200)
...
[第48节：商品列表页上拉加载效果的实现](https://www.jspang.com/detailed?id=61#toc2201)

在列表页中都是需要两个基本的功能需求：上拉加载和下拉刷新。这节课我们就来学习一下Vant的List组件，然后用List组件来实现上拉加载效果。

[实现上拉加载效果](https://www.jspang.com/detailed?id=61#toc3202)

Vant中的List组件是有下拉加载效果的，这里直接使用。 1.我们先进行引入。在`src/main.js`中加入引入代码：
...
[第49节：商品列表页下拉刷新效果的实现](https://www.jspang.com/detailed?id=61#toc2203)

列表页的下拉刷新，并不是指刷新整个页面，如果刷新整个页面，那样用户的体验效果会非常的差，这节课就来学习下拉刷新的实现。

[1.引入Vant中的PullRefresh组件](https://www.jspang.com/detailed?id=61#toc3204)
...
[2.增加下拉刷新用的变量和方法](https://www.jspang.com/detailed?id=61#toc3205)
...
[3.编写template部分](https://www.jspang.com/detailed?id=61#toc3206)
...
[第50节：商品类别分类的Koa2分页服务制作](https://www.jspang.com/detailed?id=61#toc2207)

学会了上拉加载和下拉刷新的效果，现在我们可以根据我们的需求来修改Koa2中的数据读取服务了，以前我们作的只是一个测试，不能完全满足于现在的业务逻辑，这节课我们就来改造后台的服务代码。

[修改Koa2服务代码](https://www.jspang.com/detailed?id=61#toc3208)
...
[把写好的接口加入到前台](https://www.jspang.com/detailed?id=61#toc3209)
...
[第51节：真实数据的上拉加载效果制作](https://www.jspang.com/detailed?id=61#toc2210)

通过上节课的学习，我们已经制作好了后台的Koa2服务，有了服务，我们就可以从数据库中取得真实的数据，那这节我们开始制作前台的真实数据上拉加载效果。

[在data属性里注册必要的参数](https://www.jspang.com/detailed?id=61#toc3211)
...
[编写axios商品列表的获取方法](https://www.jspang.com/detailed?id=61#toc3212)
...
[点击获取子类商品信息的方法](https://www.jspang.com/detailed?id=61#toc3213)
...
[改造大类的方法](https://www.jspang.com/detailed?id=61#toc3214)
...
[编写OnLoad方法，实现上来加载效果](https://www.jspang.com/detailed?id=61#toc3215)
...
[编写html和CSS](https://www.jspang.com/detailed?id=61#toc3216)
...
[第52节：真实数据的下拉刷新效果制作](https://www.jspang.com/detailed?id=61#toc2217)

其实我们已经学会了下拉刷新效果，但当时并没有真实的去读取服务端数据，所以这几课花几分钟时间来讲一下下拉刷新的真实数据读取。

[下拉刷新效果的制作](https://www.jspang.com/detailed?id=61#toc3218)
...
[补充，首页类别导航图片大小不一Bug的解决](https://www.jspang.com/detailed?id=61#toc3219)
...
[第53节：Vue中图片失效替补图片的制作方法](https://www.jspang.com/detailed?id=61#toc2220)

在获取的商品信息中，有一些商品图片已经失效，向这类问题，如果你真的在实际项目中遇到，但又没办法即时解决，这时候公司是不允许你这样直接显示图片失效的，我们需要显示一个替补图片。 我们正好在项目中遇到了这个问题，就拿出来给大家讲一下，因为群里的小伙伴真的很多人不会这个处理方式，我希望可以帮到他们。

[制作一张替补图片](https://www.jspang.com/detailed?id=61#toc3221)

如果你会PS，你可以制作一张替补图片，越漂亮越好，但是尽量不要使用彩色，而是使用黑白灰来制作，这样才能更像一张替补图片。 如果你不会，可以直接到我的github上来寻找这张图片，或者在网上随便找一张。

[把图片放到相应位置](https://www.jspang.com/detailed?id=61#toc3222)

把图片命名为`errorimg.png`,并放到`/src/assets/images/errorimg.png`。 然后在`src/components/pages/CategoryList.vue` 中的data中加入errorImag属性，代码如下。
...
[在图片位置加入onerror事件](https://www.jspang.com/detailed?id=61#toc3223)
...
[第54节：商品列表页编程式导航的制作](https://www.jspang.com/detailed?id=61#toc2224)

商品类别列表页的效果制作的已经差不错了，我们这节课作为一个补充，说一下编程式导航的做法和价格过滤器的写法。

[编程式导航](https://www.jspang.com/detailed?id=61#toc3225)
...
[价格过滤器的添加](https://www.jspang.com/detailed?id=61#toc3226)
...
[第55节：购物车页面的的建立](https://www.jspang.com/detailed?id=61#toc2227)

从这节课开始用几节的文章，开始制作购物车页面，购物车页面不合后台交互，并且还要保持用户数据的持久化，主要知识点在H5新增localStorage本地存储里，我们也把重心放在localStorage上。

[建立购物车页面](https://www.jspang.com/detailed?id=61#toc3228)
...
[加入头部区域](https://www.jspang.com/detailed?id=61#toc3229)
...
[配置路由](https://www.jspang.com/detailed?id=61#toc3230)
...
[得到购物车数据方法编写](https://www.jspang.com/detailed?id=61#toc3231)
...
[第56节：购物车中商品的添加](https://www.jspang.com/detailed?id=61#toc2232)
...
[向购物车中添加商品](https://www.jspang.com/detailed?id=61#toc3233)
...
[第57节：购物车清空和商品布局(Flex)](https://www.jspang.com/detailed?id=61#toc2234)

现在购物车里已经可以添加商品数据了，那我们这节要作的就是把这些数据显示出来。这节可能稍微简单，因为都是布局相关的，你需要的是耐心，把页面做好，尽量比技术胖作的好看。在商品布局之前，我们先来作一个清除购物车的按钮

[上节课程序的问题说明](https://www.jspang.com/detailed?id=61#toc3235)

上节课视频中是有一点错误的，就是购物车中的商品名称没有显示出来。那这节课我们来改正一下，名称没有出来的原因是我们的赋值变量写错了，大小写问题。 把`/src/components/pages/Goods.vue`里的向购物车添加商品的方法进行修改`addGoodsToCart`,主要修改代码：
...
[清空购物车按钮的制作](https://www.jspang.com/detailed?id=61#toc3236)

由于以前存在了一些不合法的数据，现在需要把`localStorage`里的`cartInfo`数据清空，这时候我们需要一个清空按钮. `/src/components/pages/Cart.vue`里的模版里写一个button。
...
[购物车商品的布局](https://www.jspang.com/detailed?id=61#toc3237)

有很多小伙伴提意见，你一直用`Vant`的布局方法，可是我们想学一下Flex布局，毕竟这才是工作中经常用到的。那这次就用flex布局来进行了。 由于讲解过多，这段的讲解就在视频中进行了。
...
[第58节：购物车中的商品价格计算](https://www.jspang.com/detailed?id=61#toc2238)

现在购物车已经可以添加商品了，可价格还没有进行计算，这节课来看看价格的计算方法。Vue的双向数据绑定让计算价格变的相当容易，只要对data属性力度cartInfo属性进行编辑，就会自动呈现在页面上。

[商品价格的格式化](https://www.jspang.com/detailed?id=61#toc3239)
...
[改造template,增加单个商品总价计算](https://www.jspang.com/detailed?id=61#toc3240)
...
[商品总价的计算](https://www.jspang.com/detailed?id=61#toc3241)
...
[第59节：底部导航栏和子导航的制作](https://www.jspang.com/detailed?id=61#toc2242)

现在已经有了三个页面，我们切换页面还是需要在地址栏输入，然后才能有所变化，这节课我们就学习一下底部导航的制作。

[引入tabbar组件](https://www.jspang.com/detailed?id=61#toc3243)
...
[新建Main.vue文件](https://www.jspang.com/detailed?id=61#toc3244)
...
[子导航的制作](https://www.jspang.com/detailed?id=61#toc3245)
...
[第60节：底部导航栏优化](https://www.jspang.com/detailed?id=61#toc2246)

现在已经有了底部菜单，但是还有一些小Bug需要我们处理一下。比如从商品详情页面进入购物车是底部导航不跟随变化，还有有些页面拉不到底部。这节课我们就解决一下这些小问题。

[购物车页面底部导航的处理](https://www.jspang.com/detailed?id=61#toc3247)

购物车页面出现底部导航不跟随变化的主要问题是，我们不是点击导航进入的，而是通过编程是导航进入的，这样导航栏就没有互动和触发事件，所以并没有发生变化。解决的思路就是跟踪获取路径，根据路径改变导航栏的变化。 1.先写一个方法，方法是获得路径，然后判断路径是不是`/Cart`,是就把`this.active`变成2，就可以了，代码如下：
...
[商城首页不能拉到底部的修改](https://www.jspang.com/detailed?id=61#toc3248)
...
[列表页Bug的解决](https://www.jspang.com/detailed?id=61#toc3249)
...
[第61节：底部导航栏的keep-alive设置（完结）](https://www.jspang.com/detailed?id=61#toc2250)
