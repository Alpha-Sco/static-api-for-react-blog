...
[p03：制作博客公用头部并形成组件](https://www.jspang.com/detailed?id=52#toc210)
...
[编写`advert.css`文件](https://www.jspang.com/detailed?id=52#toc326)
...
[认识egg.js框架](https://www.jspang.com/detailed?id=52#toc342)
...
[创建数据库](https://www.jspang.com/detailed?id=52#toc354)
...
[p22：前台文章列表页的制作1-接口模块化和读取文章分类](https://www.jspang.com/detailed?id=52#toc279)
...
[编写统一中台API配置文件](https://www.jspang.com/detailed?id=52#toc380)
...
[修改首页接口 读取文章类别信息](https://www.jspang.com/detailed?id=52#toc381)
...
[修改数据库](https://www.jspang.com/detailed?id=52#toc382)
...
这时候我们就有了图标字段并且有了值，再次修改``组件的代码，加入图标的部分，并且把博客首页也加上去。

[修改Header组件](https://www.jspang.com/detailed?id=52#toc383)
...
这些都准备好以后，就可以写我们的JSX语法，修改``组件部分了，代码如下：
...
[p23：前台文章列表页的制作2-根据类别读取文章列表](https://www.jspang.com/detailed?id=52#toc284)
...
[编写根据类别ID获取文章列表接口](https://www.jspang.com/detailed?id=52#toc385)
...
[路由和接口管理文件](https://www.jspang.com/detailed?id=52#toc386)
...
[编写前台UI界面](https://www.jspang.com/detailed?id=52#toc387)
...
当`getInitialProps`写完后，就可以编写JSX部分了，这里主要是循环部分``组件的代码。
...
编写完成后，去浏览器预览，发现这时候切换类别不变，因为我们没必要每个列别都去服务器重新请求，而是通过中台得到数据，就可以实现变化。如果你像每次重新请求也很简单，只要使用``标签就可以了。
...
[p24：让前台所有页面支持Markdown解析](https://www.jspang.com/detailed?id=52#toc288)
...
[首页对Markdown语法的解析](https://www.jspang.com/detailed?id=52#toc389)
...
设置完成后，在JSX部分的``组件中进行修改，主要修改的代码如下。
...
[p25：后台开发01-开发环境搭建](https://www.jspang.com/detailed?id=52#toc290)
...
[用脚手架生成项目](https://www.jspang.com/detailed?id=52#toc391)
...
[安装和引入Ant Design](https://www.jspang.com/detailed?id=52#toc392)
...
[p26：后台开发02-页面路由配置](https://www.jspang.com/detailed?id=52#toc293)
...
[安装 react-router-dom](https://www.jspang.com/detailed?id=52#toc394)
...
[使用Router](https://www.jspang.com/detailed?id=52#toc395)
...
[p27：后台管理系统开发03-编写登录界面](https://www.jspang.com/detailed?id=52#toc296)
...
[引入需要使用的组件](https://www.jspang.com/detailed?id=52#toc397)
...
[编写UI部分](https://www.jspang.com/detailed?id=52#toc398)
...
[编写CSS文件](https://www.jspang.com/detailed?id=52#toc399)
...
[p28：后台开发04-UI框架搭建](https://www.jspang.com/detailed?id=52#toc2100)
...
[Layout布局](https://www.jspang.com/detailed?id=52#toc3101)

`antd`提供了协助进行页面级整体布局组件``。在这个组件的API文档里提供了很多已经写好的案例，既然已经写好了，就直接复制就可以了。
...
[把Class形式改为Hooks形式](https://www.jspang.com/detailed?id=52#toc3102)
...
[p29：后台开发05-添加文章页面制作1](https://www.jspang.com/detailed?id=52#toc2103)
...
[创建增加文章页面](https://www.jspang.com/detailed?id=52#toc3104)
...
[编写标题和文章内容区域](https://www.jspang.com/detailed?id=52#toc3105)
...
[p30：后台开发06-添加文章页面制作2](https://www.jspang.com/detailed?id=52#toc2106)
...
[暂存按钮和发布按钮](https://www.jspang.com/detailed?id=52#toc3107)
...
[编写文章简介部分](https://www.jspang.com/detailed?id=52#toc3108)

这部分我们也采用``组件，预览部分直接使用``标签就可以实现。下节课我们会解析`Markdown`。
...
[编写发布时间界面](https://www.jspang.com/detailed?id=52#toc3109)
...
[p31：后台管理系统开发07-Markdown编辑器制作](https://www.jspang.com/detailed?id=52#toc2110)
...
[声明对应的useState](https://www.jspang.com/detailed?id=52#toc3111)
...
[设置marked](https://www.jspang.com/detailed?id=52#toc3112)
...
[编写实时预览对应的方法](https://www.jspang.com/detailed?id=52#toc3113)
...
[编写onChange相应事件](https://www.jspang.com/detailed?id=52#toc3114)
...
[p32：后台开发08-编写service登录接口](https://www.jspang.com/detailed?id=52#toc2115)
...
[新建main.js文件](https://www.jspang.com/detailed?id=52#toc3116)
...
[中台路由的制作](https://www.jspang.com/detailed?id=52#toc3117)
...
[登录方法的编写](https://www.jspang.com/detailed?id=52#toc3118)
...
[p33：后台开发09-实现前台登录操作](https://www.jspang.com/detailed?id=52#toc2119)
...
[设置路由](https://www.jspang.com/detailed?id=52#toc3120)
...
[后台登录方法编写checkLogin](https://www.jspang.com/detailed?id=52#toc3121)
...
[增加相应事件](https://www.jspang.com/detailed?id=52#toc3122)
...
[p34：后台开发10-中台路由守卫制作](https://www.jspang.com/detailed?id=52#toc2123)
...
[编写守卫方法](https://www.jspang.com/detailed?id=52#toc3124)
...
[前后台分离共享session的方法](https://www.jspang.com/detailed?id=52#toc3125)
...
[使用中间件实现路由守卫](https://www.jspang.com/detailed?id=52#toc3126)
...
[p35：后台开发11-读取添加文章页面的类别信息](https://www.jspang.com/detailed?id=52#toc2127)
...
[编写获取文章类别的接口](https://www.jspang.com/detailed?id=52#toc3128)
...
[编写中台路由](https://www.jspang.com/detailed?id=52#toc3129)
...
[后台apiUrl.js的设置](https://www.jspang.com/detailed?id=52#toc3130)
...
[在添加文章页面显示出类别](https://www.jspang.com/detailed?id=52#toc3131)
...
[P36：后台开发12-添加文章的方法(上)](https://www.jspang.com/detailed?id=52#toc2132)
...
[选择类别后调用方法](https://www.jspang.com/detailed?id=52#toc3133)
...
然后再``组件上的`onChange`事件上进行调用，代码如下：
...
[对发布时间文本框修改](https://www.jspang.com/detailed?id=52#toc3134)
...
[再对文章标题文本框进行修改](https://www.jspang.com/detailed?id=52#toc3135)
...
[编写文章保存方法](https://www.jspang.com/detailed?id=52#toc3136)
...
[P37：后台开发13-添加文章的方法(中)](https://www.jspang.com/detailed?id=52#toc2137)
...
[编写中台的addArticle接口](https://www.jspang.com/detailed?id=52#toc3138)
...
[编写对应的路由](https://www.jspang.com/detailed?id=52#toc3139)
...
[配置apiUrl.js文件](https://www.jspang.com/detailed?id=52#toc3140)
...
[编写saveArticle方法](https://www.jspang.com/detailed?id=52#toc3141)
...
[P38：后台开发14-添加文章的方法(下)](https://www.jspang.com/detailed?id=52#toc2142)
...
[编写中台接口方法](https://www.jspang.com/detailed?id=52#toc3143)
...
[后台apiUrl.js的配置](https://www.jspang.com/detailed?id=52#toc3144)
...
[后台保存方法的修改](https://www.jspang.com/detailed?id=52#toc3145)
...
[P39：后台开发15-文章列表制作(上)](https://www.jspang.com/detailed?id=52#toc2146)
...
[建立ArticleList.js文件](https://www.jspang.com/detailed?id=52#toc3147)
...
[编写对应的路由](https://www.jspang.com/detailed?id=52#toc3148)
...
[P40：后台开发16-文章列表制作(中)](https://www.jspang.com/detailed?id=52#toc2149)
...
[编写中台获取文章列表接口](https://www.jspang.com/detailed?id=52#toc3150)
...
[配置apiUrl.js文件](https://www.jspang.com/detailed?id=52#toc3151)
...
[后台Axios获取文章列表](https://www.jspang.com/detailed?id=52#toc3152)
...
[P41：后台开发17-删除文章](https://www.jspang.com/detailed?id=52#toc2153)

列表上节课已经完成了，但是列表就是为了更方便的管理博客文章，这节我们就一起来完成文章的删除操作。删除操作需要注意的是要防止误删，就是不小心删错了，所以在删除前我们需要再次向用户询问是否删除。

<iframe src="https://player.bilibili.com/player.html?aid=68325396&amp;cid=126313292&amp;page=22" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" width="100%" style="box-sizing: border-box; height: 34rem; border: 1px solid rgb(204, 204, 204); border-radius: 8px;"></iframe>

[删除文章中台方法编写](https://www.jspang.com/detailed?id=52#toc3154)
...
[编写apiUrl.js文件](https://www.jspang.com/detailed?id=52#toc3155)
...
[管理页面删除方法编写](https://www.jspang.com/detailed?id=52#toc3156)
...
[P42：后台开发18-修改文章（上）](https://www.jspang.com/detailed?id=52#toc2157)
...
[编写中台接口方法](https://www.jspang.com/detailed?id=52#toc3158)
...
[修改apiUrl.js文件](https://www.jspang.com/detailed?id=52#toc3159)
...
[updateArticle方法编写](https://www.jspang.com/detailed?id=52#toc3160)
...
[P43：后台开发19-修改文章（下）](https://www.jspang.com/detailed?id=52#toc2161)
...
[getArticleById方法的编写](https://www.jspang.com/detailed?id=52#toc3162)
...
[useEffect()方法的编写](https://www.jspang.com/detailed?id=52#toc3163)
...
[P44：博客部署介绍和演示](https://www.jspang.com/detailed?id=52#toc2164)
...
[Blog前台部署](https://www.jspang.com/detailed?id=52#toc3165)
...
[中台的开启](https://www.jspang.com/detailed?id=52#toc3166)
...
[后台管理的启用](https://www.jspang.com/detailed?id=52#toc3167)
...
[写在最后](https://www.jspang.com/detailed?id=52#toc3168)
